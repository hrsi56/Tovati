...
וכשתרצי לעבור לטלפון חדש? צרי גיבוי מוצפן בסיסמה ושלחי אותו לעצמך. במכשיר החדש בחרי את הקובץ מתיקיית „הורדות”, הזיני את הסיסמה — והמחזורים, המדידות והיומן שלך יחזרו אלייך. הסיסמה אינה נשמרת ואינה נשלחת יחד עם הגיבוי. [למדריך מעבר קצר וברור](https://hrsi56.github.io/Tovati/#backup-guide).

> הנתונים שלך הם לא המוצר. הם שלך, נשארים אצלך ונועדו רק לטובתך.

## מה מחכה לך בטובתי

- הגדרה ראשונית קצרה של אורך המחזור ואורך הווסת, כדי לתת הערכה שימושית כבר בהתחלה.
...
מסכי היום, הרישום והיומן קיבלו שכבה חדשה של בהירות: ברירות מחדל ניטרליות, סימון ברור של מה שכבר נרשם, תחזית בולטת וקלה יותר לקריאה, מגמת חום קצרה ומקרא מלא לצבעים ולסמלים. תכנים אינטימיים נשארים מקופלים בעדינות, בלי להסתיר ממך שכבר נשמר בהם מידע.

נוספה גם הגנה מפני יציאה מטופס עם שינויים שלא נשמרו, והחישובים הכבדים של מסך היום הועברו מרצף התצוגה כדי שהממשק יישאר חלק. הפרטיות ומנוע החיזוי נשארו ללא שינוי: אין הרשאת אינטרנט, אין ענן ואין איסוף נתונים.
...
<details>
  ...
  - [דו״ח גרסה 1.7.2](docs/RELEASE_REPORT_1.7.2_HE.md)
  - [דו״ח גרסה 1.6.5](docs/RELEASE_REPORT_1.6.5_HE.md)
  - [דו״ח גרסה 1.6.4](docs/RELEASE_REPORT_1.6.4_HE.md)
  - [דו״ח גרסה 1.7.1](docs/RELEASE_REPORT_1.7.1_HE.md)
  - [דו״ח גרסה 1.7.0](docs/RELEASE_REPORT_1.7.0_HE.md)
  - [דו״ח גרסה 1.6.3](docs/RELEASE_REPORT_1.6.3_HE.md)
  - [דו״ח גרסה 1.6.2](docs/RELEASE_REPORT_1.6.2_HE.md)
