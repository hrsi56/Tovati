...
<p align="center">
  ...
  ·
  <a href="docs/RELEASE_REPORT_1.7.0_HE.md">לדו״ח הגרסה</a>
</p>
...
מנוע החיזוי שופר כך שיעבוד היטב גם בלי לבצע בדיקות LH: נוזל צוואר הרחם וההיסטוריה האישית מניעים את התחזית קדימה, חום השחר משמש לאישור וללמידה, ומחזור מלא ראשון כבר משפיע בזהירות על החיזוי הבא. יום ללא מדידה נשאר חסר — הוא אינו מקבל ערך ממוצע ואינו הופך לתוצאה שלילית. נוסף גם הסבר קצר ונעים למדידת חום השחר, בלי צורך לבחור או לשמור מקום מדידה באפליקציה.

הגרסה גם מותאמת להתנהגות התצוגה מקצה לקצה של Android 15 ומעלה, בלי ממשקי הצבע וה־cutout הישנים שעליהם התריעה Google Play.
