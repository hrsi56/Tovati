...
<p align="center">
  ...
  ·
  <a href="docs/RELEASE_REPORT_1.6.3_HE.md">לדו״ח הגרסה</a>
</p>
...
תוקן באג שבו עריכת מדידת חום קיימת ושינוי התאריך שלה לתאריך אחר מחקה בטעות את המדידה של התאריך המקורי. שמירת מדידה נפתרת עכשיו אך ורק לפי התאריך שנבחר, כך שהיא לעולם לא נוגעת בתאריך אחר. תוקן גם מצב נדיר שבו מסך הזנת המדידה נתקע ולא איפשר לשמור אחרי שמירה מוצלחת קודמת.
