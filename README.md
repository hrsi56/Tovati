...
<p align="center">
  ...
  ·
  <a href="docs/RELEASE_REPORT_1.6.5_HE.md">לדו״ח הגרסה</a>
</p>
...
בהפעלה הראשונה טובתי שואלת בעדינות אם השתמשת באפליקציה בעבר. אפשר לבחור מיד גיבוי מוצפן, להזין את הסיסמה ולהמשיך עם כל המחזורים, המדידות וההגדרות — בלי לעבור שוב את כל ההגדרה הראשונית.

נוסף גם מדריך מעבר ברור לטלפון חדש באתר ובאפליקציה, וקישור אליו מצורף למייל של הגיבוי. הפרטיות נשארה ללא שינוי: אין הרשאת אינטרנט, אין גיבוי ענן ואין הרשאת אחסון רחבה.
